        ...
        <div class="signup">
          ...
          <form action = "<%=request.getContextPath()%>/common/mypage/modify" class="signup-form" id="modifyForm" name="modifyForm" method="post" enctype="multipart/form-data">
            ...
            <div class="input-field">
              <label>* 주소</label>
              <div>
                <input id = "emp_Add1" name="emp_Add1"  type="text" value = "${loginUser.emp_Add1}" placeholder="우편번호" required />
                <input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" /><br />
              </div>
            </div>
            <div class="input-field">
              <label>* 우편번호</label>
              <input id = "emp_ZipCode" name="emp_ZipCode" type="text" value ="${loginUser.emp_ZipCode}" placeholder="우편번호" required /><br />
            </div>
            <div class="input-field">
              <label>* 상세주소</label>
              <input id = "emp_Add2" name="emp_Add2" type="text" value ="${loginUser.emp_Add2}" placeholder="상세주소" required /><br />
            </div>
