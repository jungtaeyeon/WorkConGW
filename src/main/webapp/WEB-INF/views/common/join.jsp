    ...
    <form action="<%=request.getContextPath()%>/emp/register" class="signup-form" method="post" id="join">
      ...
      <div class="input-field">
        ...
        <select id = "attendStId" name="attend_St_Id" class="form-control">
          ...
          <option value="0" ${loginUser.attend_St_Id eq '0'? 'selected' : '' }>퇴근</option>
          <option value="2" ${loginUser.attend_St_Id eq '2'? 'selected' : '' }>지각</option>
          <option value="3" ${loginUser.attend_St_Id eq '3'? 'selected' : '' }>조퇴</option>
        </select>
      </div>
