      ...
      <section class="subPageContain">
        ...
        <div class="contentConteiner">
          ...
          <table class="table table-hover">
            ...
            <tbody>
                <c:forEach var="messageList" items="${receiverList}" varStatus="loop">
                    <tr>
                        ...
                        <td class="listModalBtn" onclick="location.href='receiverDetail?message_id=${messageList.message_id}&message_emp_id=${messageList.emp_id}'">
