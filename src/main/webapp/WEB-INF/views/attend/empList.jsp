            ...
            // 	data:dataSet,
                ...
                success: function(data) {
                    ...
                    data.forEach(function(e, i) {
                        ...
                        if(position){
                            li = '<li onclick="empChecked(this);" data-deptId="'+deptSupId+'" data-empId="'+deptId+'" data-name="'+deptName+" "+position+'" data-dept="'+deptSupName+'" data-state="'+(empState==null ? '' : empState)+'" ondblclick="addEmpList();" id="'+ deptId +'" lvl="'+level +'" class="myChecked" style="cursor:pointer" ><img src="<%=request.getContextPath() %>js/treeview/images/emp.png" >'+" "+ deptName + " "+e.position+'</li>';
                        }else{
                            li = '<li id="'+ deptId +'" lvl="'+level +'"><a data-deptid="'+ deptId +'" class="file code" style="cursor: pointer;" onclick="myClick(this);" >'+ deptName +'&nbsp&nbsp<i data-id="'+deptId+'" data-name="'+deptName+'" style="color:#383d41; cursor:pointer;"></i></a></li>';
                        }
