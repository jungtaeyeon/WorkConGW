...
<nav class="navbar navbar-fixed-top" style="top:0px; padding: 0; height: 80px;">
	<div class="container-fluid" style="background-color:#0a1218; height: 100%;">
		...
		<div class="navbar-brand">
			<a href="${pageContext.request.contextPath }/common/home" style="color:white;font-weight: bold;"><span>관리자페이지</span></a>
		</div>
		...
		<div id="navbar-menu">
			...
			<div class="user-account">
				...
				<div class="dropdown" id="usernameBox">
					...
					<c:if test="${loginUser.auth_Id ne 's'}">
						<li><a href="${pageContext.request.contextPath}/admin/main"><i class="icon-direction"></i>홈화면으로가기</a></li>
					</c:if>
