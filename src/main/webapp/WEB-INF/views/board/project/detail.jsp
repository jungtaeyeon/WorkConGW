			                            ...
			                            <div class="dd dd4" id="todo">
											...
											<c:if test="${!empty todoList }">
				                                <ol class="dd-list">
													...
													<%-- 비동기 처리를 위해 id값 주기 --%>
					                                    <li class="dd-item" id="${issue.issue_Board_Id}" style="cursor:pointer; margin-top: 20px; position: relative;">
															<div class="dd-handle card" style="height:70vh;margin-left: 0px; padding:10px 10px;height:auto;color:black;border:1px solid rgb(0,0,0,0.2);">
																<div style="margin-bottom: -15px;">
																	<h6 style="display:inline-block;font-weight: bold;max-width: 85%; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;vertical-align: middle;">
																		...
																		<span class="issueTitle" style="font-size:1.1em;">${issue.issue_Board_Title }</span>
																	</h6>
																		<span class="btn btn-secondary" style="height:auto;padding: 0px 3px;font-size:0.8em;margin-left:5px;margin-top: -10px;">#${issue.duty_Board_Id }</span>
																</div>
															...
															<div class="user-account" style="position: absolute;top:0px;">
						                                        <div class="dropdown">
												                    <ul class="dropdown-menu dropdown-menu-right account animated flipInY menuProfile" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: -100px; padding:10px;transform: translate3d(89px, 42px, 0px);">
																			...
																			<li data-id="${issue.issue_Board_Id }" data-st="done" data-issue_St=2 data-title="${issue.issue_Board_Title }" onclick="modifyIssue(this);"><a href="javascript:void(0);"><i class="fas fa-check-circle"></i><span>이슈 완료</span></a></li>
												                    </ul>
												                </div>
					                                        </div>
															<%-- 프로젝트 상태 변경 끝 --%>
