...
<%--                                select 는 임시--%>
                                <select name="searchDutyVO.searchCondition" class="form-control selectSearch" style="width:130px;font-size: 1.2em;float:left;">
                                    <option value="tcmn">전체</option>
                                    <option value="t">제목</option>
                                    <option value="c">내용</option>
                                    <option value="m">담당자</option>
                                    <option value="n">업무번호</option>
                                </select>
...
<%--                                    임시로 input 마찬가지로 백단 끝나면 form 태그 사용--%>
                                    <input name="searchDutyVO.searchKeyword" class="form-control" placeholder="검색어 입력" type="text" style="width: 500px;height:36px;padding-right: 40px;" onkeypress="checkEnter(searchDutyList);"/>
