...
<section class="subPageContain">
    ...
    <div class="contentConteiner">
        <div class="subTitleText"> <!--컨텐츠 부분 타이틀 클래스(이건 부트스트랩 클래스 아니고 임의로 만든 클래스)-->
            <h2><i class="fa-solid fa-angles-right"></i> <!--왼쪽 아이콘 폰트어썸-->반려문서</h2>
            <div class="btnGroup">
                &nbsp
                <button type="button" class="btn btn-dark myBtn" style="width: 100px;" onClick="location.href='<%=request.getContextPath()%>/approval/lists/rejectList'">목록</button>
