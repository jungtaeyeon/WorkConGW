                ...
                <div class="row clearfix">
                    <div class="col-12" style="padding: 0;">
                        <div class="subTitleText">
                            <h2><i class="fa-solid fa-angles-right"></i>상신문서</h2>
                        </div>
                    </div>
                </div>
                            ...
                            <form:form modelAttribute="approvalFormVO" id = "listForm" name = "listForm" method="get">
                                <div class="body">
                                    ...
                                    <div style="margin-bottom: 20px;">
                                        ...
                                        <form:select path ="searchApprovalVO.searchState" id = "selectSearchState" class="form-control selectState myConditions" style="width:200px;margin-right:15px;float:left; display:none;">
