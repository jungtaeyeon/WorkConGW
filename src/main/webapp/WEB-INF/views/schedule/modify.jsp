...
<%--                    </c:if>--%>
            ...
            <div class="row">
                <div class="col-xs-12" style="margin: 0px 5px;">
                    <input id="edit-important" type="checkbox" style="width: 25px; height: 25px;" class="float-left"  data-toggle="toggle" ${schedule.imp eq 'true' ? 'checked' : ''}>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <textarea rows="4" cols="50" class="form-control" name="edit-desc" id="edit-desc" >${schedule.content }</textarea>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function modifySchedule(){
        //alert("수정 클릭");
        var fixedSchduleId = $('#shcedule_Id');
